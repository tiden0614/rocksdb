...
/*
 * Class:     org_rocksdb_Options
 * Method:    setDbPathUseStrategy
 * Signature: (JB)V
 */
void Java_org_rocksdb_Options_setDbPathUseStrategy(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jbyte strategy) {
  reinterpret_cast<rocksdb::Options*>(jhandle)->db_path_use_strategy =
    static_cast<rocksdb::DbPathUseStrategy>(strategy);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    dbPathUseStrategy
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_Options_dbPathUseStrategy(JNIEnv* /*env*/,
                                                 jobject /*jobj*/,
                                                 jlong jhandle) {
  return reinterpret_cast<rocksdb::Options*>(jhandle)->db_path_use_strategy;
}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_Options_setCFPaths(JNIEnv* env, jobject /*jobj*/,
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_Options_cfPathsLen(JNIEnv* /*env*/, jobject /*jobj*/,
                                                      jlong jhandle) {
  auto* opt = reinterpret_cast<rocksdb::Options*>(jhandle);
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_Options_cfPaths(JNIEnv* env, jobject /*jobj*/,
                                      jlong jhandle, jobjectArray jpaths,
                                      jlongArray jtarget_sizes) {
  jlong* ptr_jtarget_size = env->GetLongArrayElements(jtarget_sizes, nullptr);
  if (ptr_jtarget_size == nullptr) {
...
/*
 * Class:     org_rocksdb_Options
 * Method:    setCFPathUseStrategy
 * Signature: (JB)V
 */
void Java_org_rocksdb_Options_setCFPathUseStrategy(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle,
                                                   jbyte strategy) {
  reinterpret_cast<rocksdb::Options*>(jhandle)->cf_path_use_strategy =
    static_cast<rocksdb::DbPathUseStrategy>(strategy);
}

/*
 * Class:     org_rocksdb_Options
 * Method:    cfPathUseStrategy
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_Options_cfPathUseStrategy(JNIEnv* /*env*/,
                                                 jobject /*jobj*/,
                                                 jlong jhandle) {
  return reinterpret_cast<rocksdb::Options*>(jhandle)->cf_path_use_strategy;
}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setCFPaths(JNIEnv* env, jobject /*jobj*/,
                                                     jlong jhandle, jobjectArray jpaths,
                                                     jlongArray jtarget_sizes) {
  std::vector<rocksdb::DbPath> db_paths;
  jlong* ptr_jtarget_size = env->GetLongArrayElements(jtarget_sizes, nullptr);
 ...
 * Signature: (J)J
 */
jlong Java_org_rocksdb_ColumnFamilyOptions_cfPathsLen(JNIEnv* /*env*/, jobject /*jobj*/,
                                                      jlong jhandle) {
  auto* opt = reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle);
  return static_cast<jlong>(opt->cf_paths.size());
}
 ...
 * Signature: (J[Ljava/lang/String;[J)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_cfPaths(JNIEnv* env, jobject /*jobj*/,
                                                  jlong jhandle, jobjectArray jpaths,
                                                  jlongArray jtarget_sizes) {
  jlong* ptr_jtarget_size = env->GetLongArrayElements(jtarget_sizes, nullptr);
  if (ptr_jtarget_size == nullptr) {
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_ColumnFamilyOptions_setCFPathUseStrategy(JNIEnv* /*env*/,
                                                               jobject /*jobj*/,
                                                               jlong jhandle,
                                                               jbyte strategy) {
  reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle)->cf_path_use_strategy =
    static_cast<rocksdb::DbPathUseStrategy>(strategy);
}
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_ColumnFamilyOptions_cfPathUseStrategy(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle) {
  return reinterpret_cast<rocksdb::ColumnFamilyOptions*>(jhandle)->cf_path_use_strategy;
}
 ...
 * Signature: (JB)V
 */
void Java_org_rocksdb_DBOptions_setDbPathUseStrategy(JNIEnv* /*env*/,
                                                     jobject /*jobj*/,
                                                     jlong jhandle,
                                                     jbyte strategy) {
  reinterpret_cast<rocksdb::DBOptions*>(jhandle)->db_path_use_strategy =
    static_cast<rocksdb::DbPathUseStrategy>(strategy);
}
 ...
 * Signature: (J)B
 */
jbyte Java_org_rocksdb_DBOptions_dbPathUseStrategy(JNIEnv* /*env*/,
                                                   jobject /*jobj*/,
                                                   jlong jhandle) {
  return reinterpret_cast<rocksdb::DBOptions*>(jhandle)->db_path_use_strategy;
}
